...
export default [{
    ...
    titleCard: {
        ...
        name: "SKTKawaiiNeko",
        title: "⭐⭐⭐⭐⭐ Master Chef",
        image: "https://cdn.discordapp.com/attachments/1206312191326822441/1444825072241086534/VSTRAY_ART_NEKO_999_black_and_white.png",
    },
    results: {
    ...
    titleCard: {
        ...
        image: "https://cdn.discordapp.com/attachments/817061695406604330/1444760391254016091/VRChat_2025-11-27_23-15-46.098_3840x2160.png",
    },
    results: {
    ...
    titleCard: {
        intro: "The savory aroma of Little Nero’s Pizza from the kitchen makes your stomach grumble, hearing another behind as you turn around to a smelly pink cat...",
        name: "Lil_Todo",
        title: "The Pink One",
        image: "https://media.discordapp.net/attachments/1444760023577133249/1444840430448676995/image.png",
    },
    results: {
    ...
    titleCard: {
        intro: "You Hear a ring... You seem to remember setting an alarm, right?",
        name: "The Child",
    ...
    titleCard: {
        intro: "A very S Q U A R E Sheep",
        name: "Jakkuba",
        title: "Piston Sheep",
        image: "https://cdn.discordapp.com/emojis/1395604222728339557.webp",
    },
    results: {
        victory: "Once again she sheep gets the piston. How could you?",
        defeat: "Team {name} gets the piston this time.",
        allGather: "With no one to throw or shield, Team {name} was easily dealt with.",
        allThrow: "Everyone lines up to throw, but no one from Team {name} gathered any snow... So they are easily defeated.",
        allShield: "All from Team {name} join their shields together, but with no snow to throw, they are picked off one by one by the Sheep",
        uncontested: "No one from Team {name} even attempted to stop the Piston..."
    },
    difficulty: 40
}, {
    titleCard: {
        intro: "From the editing dungeon deep in Tot's Basement come the cries of a forgotten soul. 'Wake up hnuy' her partner calls. 'I wanna gaslight Tot's discord again.' For this fight, snowballs are now unedited stream clips!",
        name: "Tombzon",
        title: "Power Couple",
        image: "https://media.discordapp.net/attachments/1190867403756802118/1317661030985367662/VRChat_2024-12-12_23-21-01.963_3840x2160.png?ex=692d94b6&is=692c4336&hm=b290f77b38b4b85a5b543e934aff52c5ae793647d012e6fec60e16265febe1b5&format=webp&quality=lossless&width=1618&height=910&",
    },
    results: {
        victory: "By throwing raw, unedited clips at Kuzon, Team {name} make her so anxious about bad content that she goes back into the dungeon to start over. 'NO HNUY' Tombstone calls. 'YOU DON'T WORK THERE ANYMORE.'",
        defeat: "Despite their best efforts, Team {name} can't stop Tomb from giving Kuzon his 'good ideas,' and the next YT video tanks. Team {name} retreats into the dark.",
        allGather: "The unified strength of the whole team enables them to gather a mountain of clips, but they shove them into Kiritsu's hands, so nothing actually happens...",
        allThrow: "With an army of allies lined up and ready to fight, it took little effort for Tombzon to defeat them... seeing as they had no clips to distract her...",
        allShield: "The battle dragged out for hours, neither side backing down. Eventually, Tombstone got bored and started to tickle Kuzon's feet, and the whole fight just sort of died out...",
        uncontested: "Without anyone to protest, Kuzon and Tombstone continued their rampage...until they got bored and ran off to go watch anime and eat fried rice together..."
    },
    difficulty: 50
}, {
    titleCard: {
        intro: "She seeks a fair battle, the one Goat above all. make ready yourselves, lest you stumble and fall",
        name: "SanaSnarly",
        title: "The Goat",
        image: "https://cdn.discordapp.com/attachments/1020998304672256030/1444603401877848075/hahaha.png",
    },
    results: {
        victory: "Bravo! A battle most marvelous, the crowd must seek more! Call upon her again, to give them an encore",
        defeat: "Hah! Tis no surprise, against one so divine. Such is the reason, she's the Goat of All Time.",
        allGather: "You all gather snow, a tactic so poor. You surely dont know, what you gather it for?",
        allThrow: "Throw as you may, you lack snow in your hands. Today was the day, The Goat ruined your plans.",
        allShield: "You clutch to your friends, all shielded in fear. No snowballs were thrown, and no snow gathered either.",
        uncontested: "You hide from The Goat. Are you already spent? She hopes you find out, where your bravery went."
    },
    difficulty: 50
}, {
    titleCard: {
        intro: "A sleepy boi walks the streets infecting all those around with sleep",
        name: "Kami",
        title: "Sleepy boi",
        image: "https://cdn.discordapp.com/attachments/1206312191326822441/1444829926267031723/image.png",
    },
    results: {
        victory: "The sleepy boi gets cold from all the snow and decides to move to a more comfy place",
        defeat: "Team {name} lays scattered across the battlefields... sleeping...",
        allGather: "you all gather lots of snow to make the perfect bed to sleep on with the sleepy boi.",
        allThrow: "Your arms are heavy as you fail to even raise them before you fall fast asleep.",
        allShield: "you all gather together to shield yourself but only end up making a large cuddle puddle for the sleepy boi.",
        uncontested: "The sleepy boi makes sure to roam quietly as everyone seems to already be asleep."
    },
    difficulty: 40
}, {
    titleCard: {
        intro: "A faint rumbling and clattering of machinery can be heard out in the shed...",
        name: "User K-4-T",
        title: "Weird Lookin Cat",
        image: "https://cdn.discordapp.com/attachments/438913221479497729/1444832711360381011/RobotBoss.png",
    },
    results: {
        victory: "The robot sputters and beeps frantically before falling silent as Team {name} puts it back in the shed.",
        defeat: "Team {name} falls to the robot covered in a small mountain of snow.",
        allGather: "Everyone gathers the resources they need, forgetting to fight the robot, the shed lights on fire :(",
        allThrow: "Team {name} rushes to the bot, forgetting to bring ANYTHING with them, the robot looks more confused than anything, shooing away all of Team {name}.",
        allShield: "Everyone huddles together bracing together, unfortunately that means nobody stopped the robot and the shed exploded... I don't think that counts as a win.",
        uncontested: "The sounds of clanking metal can be heard for most of the night, nobody went to investigate, until the shed caught on fire."
    },
    difficulty: 80
}, {
    titleCard: {
        intro: "He stopped moving, that can't be good...",
        name: "Kiritsu",
        title: "Little Shit",
        image: "https://cdn.discordapp.com/attachments/1206312191326822441/1443383542254928034/OldKiri.png",
    },
    results: {
        victory: "with some unknown power, Team {name} succeed to ban Kiritsu.  His last word were: 'I'll go talk with chat 2 then' - Totless 2024",
        defeat: "Team {name} is now hiding.  Look like Kiritsu found shameful clips of the chat.",
        allGather: "Team {name} unite, time to try to hide every clips or sound clips of their shameful action.  Will they hide everything?",
        allThrow: "Team {name} throw lewd pictures of streamers and lot of clips to Kiritsu hoping he will have too much work to focus on them.",
        allShield: "With the help of Totless, Team {name} succeed to mute Kiritsu but it's only temporary.",
        uncontested: "Not even trying? Team {name} don't even deserve a clip."
    },
    difficulty: 20
}, {
    titleCard: {
        intro: "Why is it suddenly so dark?",
        name: "Ngojuice",
        title: "END",
        image: "https://media.discordapp.net/attachments/1206312191326822441/1444841229303943168/VRChat_2025-11-26_17-08-59.313_2560x1440.png",
    },
    results: {
        victory: "'How fascinating. Even though you're so frail and small, you're able to last this long.' Amused by Team {name} 's determination, Ngojuice decides to spared them and vanishes in mist leaving marks onto the snowy battlefield. Now imagine if they took this seriously?",
        defeat: "Although Team {name} tried their best, they were no where close to reaching the peak. 'How very disappointing. I thought for sure I'd have more fun with you guys than this'",
        allGather: "The unified strength of the whole team enables them to gather a mountain of snow. This doesn't help the fight at all but hey... they tried... I guess.",
        allThrow: "'Maybe if your intellect was as high as your imagination, you might've actually done something.' ",
        allShield: "All of Team {name} huddles up to protect each other but end up making themselves easier to crush at once.",
        uncontested: "You didn't stand a chance anyways."
    },
    difficulty: 90
}, {
    titleCard: {
        intro: "Brought forth before the judge and jury to fight the allegations, his fate left in your hands...",
        name: "Draxian",
        title: "The Accused",
        image: "https://cdn.discordapp.com/attachments/1419773868758925332/1444837714422792283/DragonDraxian_DP_ART.png",
    },
    results: {
        victory: "As the the snow keeps being thrown and the accusations pile higher and higher, Team {name} is unrelentless. In the end the allegations still stand, you win this time, but I'll be back...",
        defeat: "The accusations and snow falls short of even close to hitting the mark, as Team {name} tries their best. Looks like he's finally beaten the allegations once and for all...",
        allGather: "As the gather all the snow and evidence, Team {name} fails to have time to hit the mark or defend themselves. Drax leaves the team to think about their loss, better luck next time...",
        allThrow: "As Team {name} prepares and winds up, it becomes painfully obvious they have nothing to use. Today Drax get's away with it without even trying...",
        allShield: "The back and forth was relentless as Team {name} puts everything into their defense, but in the end turns out only defending won't get you anywhere. As Drax wins this battle of attrition, maybe next time you should have some more ammo...",
        uncontested: "With the jury being a no-show, the accusations had no way to continue, and he has finally proven the allegations wrong..."
    },
    difficulty: 60
}, {
    titleCard: {
        ...
        name: "Krisuna",
        title: "cat",
        image: "https://cdn.discordapp.com/attachments/1206312191326822441/1444841860685369435/VRChat_2024-03-15_22-04-35.709_1920x1080.png",
    },
    results: {
        victory: "Somehow, Team {name} takes the win, not sure how that happened, did you make sure the cat was ready?",
        defeat: "The cat outplays Team {name} and takes them all out one by one, in the distance you hear another purple cat muttering something about tryharding.",
        allGather: "Everyone in Team {name} gathers up to get ready for battle against the cat, making them all an easy target for the AoE ability (didn't you read the game rules and skill tree?)",
        allThrow: "Team {name} gets ready to throw everything they got but stops and hesitates when the cat questions the team balance of the fight, looks like you all outnumber the cat isn't that a bit unfair?",
        allShield: "Everyone in Team {name} fortifies and shields up, but nobody is attacking? It's going to take a little longer but the cat is slowly picking you off one by one, determined to win even if the battle drags on.",
        uncontested: "Nobody joined the cats game lobby."
    },
    difficulty: 50
}, {
    titleCard: {
        intro: "Hey guys did you hear...",
        name: "It's not THAT deep",
        title: "...like seriously!",
        image: "https://cdn.discordapp.com/attachments/1206312191326822441/1445251238240321687/INTD.png",
    },
    results: {
        victory: "'Please just stop... it really isnt... no? okay...'",
        defeat: "'I told you so...'",
        allGather: "'Erm... what? okay...'",
        allThrow: "'Heh... cute...'",
        allShield: "'Uh huh... I see... nice try I guess?'",
